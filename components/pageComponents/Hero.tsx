...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-[calc(100vh-220px)] px-5 overflow-hidden flex items-center">
      ...
      <div className="relative container mx-auto px-5 grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        <motion.div
          ...
          className="space-y-6 justify-items-start flex flex-col items-center text-center p-8 md:p-0 md:items-start md:text-start"
        >
          ...
          <div className="flex gap-8 pt-4">
            <div>
              <p className="text-2xl font-bold text-gray-900"><CountUp end={150} duration={7}></CountUp>+</p>
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900"><CountUp end={20} duration={5}></CountUp>+</p>
        ...
        <motion.div
          ...
          className="relative flex p-8 justify-center items-center"
        >
          {/* Image */}
